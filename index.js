...
const htmlTaskContent = ({ id, title, description, type, url }) => `
    <div class='col-md-6 col-lg-4 mt-3' id=${id} key=${id}>
        <div class='card shadow shadow-primary shadow-intensity-lg task__card '>
           ...
           <div class='card-footer'>
                ...
                data-bs-target='#showTask' id=${id} onclick='openTask.apply(this, arguments)'>Open Bookmark</button>
            </div>
        </div>
    </div>
`;
...
const saveEdit = (e) => {
  ...
  submitButton.innerHTML = "Open Bookmark";
};
